...
class AppDelegate: UIResponder, UIApplicationDelegate, MessagingDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        UNUserNotificationCenter.current().requestAuthorization(options: autorizacao) { (_, _) in
            //Recupera o token que o firebase gera
            Messaging.messaging().delegate = self
            Messaging.messaging().shouldEstabilishDirectChannel = true
        }
    ...
    //Traz o token que o Firebase gera (com esse token podemos enviar a notificação para um aparelho especifico)
    ...
    func messaging(_ messaging: Messaging, didReceive remoteMessage: MessagingRemoteMessage) {
        ...
        Firebase().serealizaMensagem(mensagem: remoteMessage)
    }
    ...
    func applicationDidBecomeActive(_ application: UIApplication) {
        //Toda vez que o aplicativo se tornar ativa ele irá sincronizar os alunos
